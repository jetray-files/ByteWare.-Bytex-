...
remote.OnClientEvent:connect(function(a, id, position, vol, pitch, start, finish)
	if plr ~= lplr and a == "sond" then
		sond(id, position, 0, pitch, start, finish)
	end
end)
function sound(id, position, vol, pitch, start, finish)
	local part = sond(id, position, 0, pitch, start, finish)
	remote:FireServer("sond", id, position, 0, pitch, start, finish)
	return part
end
...
remote.OnClientEvent:connect(function(a, mesh, size, transparency, material, color, position, rotation, positionchange, sizechange, rotationchange, transparencychange, acceleration)
	if plr ~= lplr and a == "effekt" then
		Effekt(mesh, size, 1, material, color, position, rotation, positionchange, sizechange, rotationchange, 0, acceleration)
	end
end)
function Effect(mesh, size, transparency, material, color, position, rotation, positionchange, sizechange, rotationchange, transparencychange, acceleration)
	local part = Effekt(mesh, size, 1, material, color, position, rotation, positionchange, sizechange, rotationchange, 0, acceleration)
	return part
end
rs:connect(function()
	coroutine.resume(coroutine.create(function()
...
Model0.Name = "first"
Model0.Parent = game.ReplicatedStorage
Part1.Parent = Model0
